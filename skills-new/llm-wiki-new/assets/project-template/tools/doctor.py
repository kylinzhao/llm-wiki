        ...
        findings.append(
            finding(
                ...
                (
                    ...
                    "but image evidence status is still unknown. Run `llm-wiki-new image` after source refinement "
        ...
        findings.append(
            finding(
                ...
                (
                    ...
                    "source refinement/status records. `llm-wiki-new update` must process this queue automatically; "
        ...
        if stale_status_pages or low_confidence_pages:
            if local_jira_auth_configured():
                detail = (
                    ...
                    f"{low_confidence_pages} low-confidence primary selection(s). Run `llm-wiki-new update` "
