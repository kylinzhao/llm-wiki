...
def print_auth_instructions() -> None:
    print(
        ...
        "\n"
        "If the project template is not installed yet, run the skill-level script instead: `bash ${CODEX_HOME:-$HOME/.codex}/skills/llm-wiki-new/scripts/init_auth_env.sh`.\n"
        "\n"
