---
name: guazi-sso-login
description: Use when 需要获取瓜子 SSO Cookie、CHDSSO token 或 cwiki.guazi.com Wiki 登录态，特别是其他 skill 遇到未登录、Cookie/token 失效、E_NO_COOKIE、需要 CWIKI_MANUAL_COOKIE、GUAZISSO 或 chdsso 请求头时
---
