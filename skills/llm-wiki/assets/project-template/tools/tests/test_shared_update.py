...
class SharedUpdateTests(unittest.TestCase):
    ...
    def test_classifies_allowed_and_excluded_paths(self):
        ...
        self.assertTrue(shared.is_publish_allowed("staging/wiki-sync/runs/20260529T142423Z.json"))
        self.assertTrue(shared.is_publish_allowed("tools/update_wiki.py"))
        self.assertTrue(shared.is_publish_allowed("tools/tests/test_backfill.py"))
        ...
        self.assertFalse(shared.is_publish_allowed("staging/local-token.json"))
